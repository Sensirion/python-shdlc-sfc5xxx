...
version_line = open("sensirion_shdlc_sfc5xxx/version.py", "rt").read()
...
setup(
    name='sensirion-shdlc-sfc5xxx',
    version=version_string,
    author='Urban Bruhin',
    author_email='urban.bruhin@sensirion.com',
    description='Driver for Communicating With Sensirion SFC5xxx/SFM5xxx',
    license='BSD',
    keywords='sensirion shdlc mass flow controller meter driver mfc mfm '
             'sfc5400 sfm5400',
    url='https://github.com/sensirion/python-shdlc-sfc5xxx',
