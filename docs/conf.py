...
import sensirion_shdlc_sfc5xxx

# -- Project information -----------------------------------------------------

project = u'sensirion-shdlc-sfc5xxx'
copyright = u'{} Sensirion AG, Switzerland'.format(datetime.now().year)
author = u'Sensirion AG'


# The short X.Y version
version = sensirion_shdlc_sfc5xxx.__version__
# The full version, including alpha/beta/rc tags
release = sensirion_shdlc_sfc5xxx.__version__
...
autodoc_default_flags = [
    ...
    'inherited-members',    # To see the methods from sensirion_shdlc_driver
]
